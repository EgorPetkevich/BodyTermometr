...
final class PaywallProdVC: UIViewController {
    ...
    private enum TextConst {
        ...
        static func underheaderText(with price: String) -> String {
            "Then auto-renew at \(price) per week"
        }
    }
    ...
    init(viewMode: PaywallProdViewModelProtocol) {
...
//MARK: - Private
private extension PaywallProdVC {
    ...
    func setupSnapkitConstraints() {
        ...
        mainPaywallImageView.snp.makeConstraints { make in
            ...
            make.bottom.equalToSuperview().inset(213.0)
        }
    ...
    func getAttributedUnderHeaderText() -> NSAttributedString {
        ...
        attachment.image = UIImage.paywallCheckboxFill
            .withTintColor(UIColor.appBlack,
